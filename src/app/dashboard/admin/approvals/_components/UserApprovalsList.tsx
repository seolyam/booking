    ...
    return (
        <div className="space-y-6">
            {users.map((u) => (
                <div
                    key={u.id}
                    className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100/50"
                >
                    {/* Header: Name & Status */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
                        ...
                        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                            <div>
                    ...
                    {u.approval_status === "pending" && (
                        <div className="pt-6 border-t border-gray-100 flex gap-4">
                            ...
                            >
                                <Button
                                    type="submit"
                                    variant="destructive" // Keep variant but override class for specific red
