...
export default function ApproverApprovalsList({
    ...
    const [currentStatus, setCurrentStatus] = useState<ApproverDashboardRow["statusLabel"]>(activeStatus);
    ...
    const filterBtn = (status: ApproverDashboardRow["statusLabel"]) => (
        <button
            ...
            className={`px-6 py-1.5 rounded-lg text-sm font-bold transition-all border ${currentStatus === status
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-4xl font-black text-gray-900">List of budget proposals</h1>
                <p className="text-gray-500 mt-2 font-medium">Review and verify budget details before forwarding to approver</p>
            </div>
